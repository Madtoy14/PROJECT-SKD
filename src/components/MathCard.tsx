...
export default function MathCard({ explanation, category }: MathCardProps) {
  ...
  const formattedExplanation = explanation
    ...
    .replace(/(\d+)\/(\d+)/g, '<span class="inline-flex flex-col text-center align-middle mx-1 leading-none"><span class="border-b border-white/30 pb-0.5 px-1 text-[11px] font-bold text-skd-accent">$1</span><span class="text-[11px] pt-0.5 px-1 font-bold text-skd-accent">$2</span></span>');
  ...
  return (
    <div className="space-y-4 text-left w-full">
      {diketahuiList.length > 0 && (
        <div className="bg-[#1D1B26] border border-cyan-500/20 rounded-2xl p-4 relative overflow-hidden shadow-sm">
          ...
          <div className="text-xs md:text-sm text-gray-300 space-y-1.5 font-medium leading-relaxed">
      ...
      {rumusList.length > 0 && (
        <div className="bg-[#1D1B26] border-2 border-[#F5A623]/30 rounded-2xl p-4 relative overflow-hidden shadow-[0_0_15px_rgba(245,166,35,0.15)]">
          <div className="absolute top-0 right-0 w-24 h-24 bg-[#F5A623]/10 rounded-full blur-xl pointer-events-none" />
          <h5 className="text-xs font-black text-[#F5A623] mb-2 uppercase tracking-wide flex items-center gap-1.5">
            ⚡ 2. Rumus Utama & Konsep
          </h5>
          <div className="text-xs md:text-sm text-yellow-100 space-y-1.5 font-semibold bg-[#2A2315]/40 p-3 rounded-xl border border-[#F5A623]/10 leading-relaxed">
      ...
      {perhitunganList.length > 0 && (
        <div className="bg-[#1D1B26] border border-purple-500/20 rounded-2xl p-4 relative overflow-hidden shadow-sm">
          ...
          <div className="text-xs md:text-sm text-gray-300 space-y-2.5 font-medium leading-relaxed">
