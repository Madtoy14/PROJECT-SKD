...
-- =============================================
-- Add tables to realtime publication (with safe check)
DO $
BEGIN
    -- Safely add duels to realtime
    BEGIN
    ...
    -- Safely add notifications to realtime
    BEGIN
    ...
    -- Safely add friends to realtime
    BEGIN
    ...
    -- Safely add profiles to realtime
    BEGIN
...
DO $$
BEGIN
    RAISE NOTICE 'âœ… SKDQuest Extended Schema Applied Successfully!';
    RAISE NOTICE 'ðŸ“Š Created Tables: quiz_sessions, quiz_results, transactions, duels, friends, notifications, user_activity_log';
    RAISE NOTICE 'ðŸ”§ Created Functions: expire_pending_duels, calculate_user_energy, get_active_quiz_session';
    RAISE NOTICE 'ðŸ“ˆ Created Views: leaderboard_daily, leaderboard_weekly, leaderboard_alltime';
    RAISE NOTICE 'ðŸ” RLS Policies: Enabled on all tables';
    RAISE NOTICE 'âš¡ Realtime: Enabled for duels, notifications, friends, profiles';
    RAISE NOTICE '';
